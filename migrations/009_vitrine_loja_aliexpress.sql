-- ============================================================
-- 009 — view vitrine detecta AliExpress pelo link também
-- Igual ao que já se faz com Shopee/ML/TikTok: a loja de destino do botão vem do
-- short_url, não só da origem — assim um produto 'manual' com link do AliExpress
-- também mostra "Ver na AliExpress". Produto origem 'aliexpress' já caía no
-- else p.origem, mas explicitar deixa robusto e consistente.
-- ============================================================
